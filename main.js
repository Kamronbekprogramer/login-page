...
form.addEventListener("submit", (e) => {
    e.preventDefault();
    if (inputName.value && inputEmail.value && inputLink.value && inputMessage.value) { // Shartni tekshiramiz
        let newUser = {
            name: inputName.value,
            email: inputEmail.value,
            link: inputLink.value,
        ...
        alert("Iltimos, barcha maydonlarni to'ldiring!"); // Foydalanuvchiga xabarnoma chiqaramiz
    }
});
